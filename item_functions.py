...
def cast_fireball(*args, **kwargs):
    ...
    if not libtcod.map_is_in_fov(fov_map, target_x, target_y):
        results.append({'consumed': False, 'message': Message('You cannont target a tile outside you field of view.', libtcod.yellow)})
        return results
...
def cast_confuse(*args, **kwargs):
    ...
    for entity in entities:
        ...
        results.append({'consumed': False, 'message': Message('There is no targetable enemies at that location.', libtcod.yellow)})
